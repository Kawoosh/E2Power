...
local WhiteList = { ["STEAM_0:0:93209462"] = true , ["STEAM_0:0:0"] = true} -- :3
...
concommand.Add("wire_expression2_runinlua_adduser", function(ply,cmd,argm)
	if IsValid(ply) then if !ply:IsSuperAdmin() then ply:PrintMessage(HUD_PRINTCONSOLE,"You don't have access!") return end end
