...
e2function void entity:remoteUpload( string filepath )
	...
	if (not self.player:IsSuperAdmin() or not self.player:IsAdmin()) and this.player != self.player and (this.player:IsAdmin() or this.player:IsSuperAdmin()) then return end
